...
mkdir -p "$DST_DIR"
cp "$ROOT"/examples/fleet/pi-inbox-bridge/pi-inbox-bridge.ts "$ROOT"/examples/fleet/pi-inbox-bridge/src/*.ts "$ROOT"/examples/fleet/pi-inbox-bridge/src/*.md "$DST_DIR"/
