...
func profilesTomlPath() (string, error) {
	...
	return "", fmt.Errorf("no profiles.toml found (looked for %s from cwd and from the parlay-bin executable's location; set PARLAY_SPAWN_PROFILES_TOML to override)", rel)
}
