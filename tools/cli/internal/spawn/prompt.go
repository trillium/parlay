...
// tools/cli/internal/spawn/launch-templates/default.txt — that package file
// is the physical home of the template, and the repo-root
// launch-templates/default.txt is a symlink to it) with the same
