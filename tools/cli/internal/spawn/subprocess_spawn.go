...
const subprocessSpawnUsage = `Usage: parlay subprocess-spawn <agent-id> <command> <workdir> [--state-dir DIR] [--env KEY=VALUE ...] [--worktree-path PATH] [--bead-id ID]
       parlay subprocess-stop <agent-id> [--state-dir DIR]
       parlay subprocess-ping <agent-id> [--state-dir DIR]
