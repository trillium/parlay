...
- **The relay is a per-user singleton on the canonical runtime dir.** Unix socket paths cap at 104 bytes. → [notes](docs/agent-notes/the-relay-is-a-per-runtime-robots-buu8.md)
