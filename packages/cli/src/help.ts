...
Usage:
  ...
  parlay alert <text...>          Broadcast an alert to all pollers + agents (immediate)
  parlay alert --stagger <text...>      Spread delivery over time (avoid a fleet-wide API spike)
