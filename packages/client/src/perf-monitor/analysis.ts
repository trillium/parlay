// ── Parlay Performance Monitor — bottleneck analysis + reporting ─────────────

import type { SessionMetrics } from './types'

export function analyzeAndReport(metrics: SessionMetrics): void {
...
async function persistMetrics(metrics: SessionMetrics): Promise<void> {
  try {
...
function displayAnalysis(metrics: SessionMetrics): void {
